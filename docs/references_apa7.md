# Psychophysiology-Style Reference List

Generated from `docs/citation_candidates.md` and `docs/citation_candidates_expanded.md`. DOI resolution was checked via DOI.org, Crossref, and publisher records on 2026-07-08. Do not insert these into `docs/manuscript_draft.md` without the prose owner's review.
...
Keil, A., Debener, S., Gratton, G., Junghofer, M., Kappenman, E. S., Luck, S. J., Luu, P., Miller, G. A., & Yee, C. M. (2014). Committee report: Publication guidelines and recommendations for studies using electroencephalography and magnetoencephalography. *Psychophysiology, 51*(1), 1-21. https://doi.org/10.1111/psyp.12147
...
Muro, A., Goma-i-Freixanet, M., & Adan, A. (2012). Circadian typology and sensation seeking in adolescents. *Chronobiology International, 29*(10), 1376-1382. https://doi.org/10.3109/07420528.2012.728665
...
San Martin, R. (2012). Event-related potential studies of outcome processing and feedback-guided learning. *Frontiers in Human Neuroscience, 6*, Article 304. https://doi.org/10.3389/fnhum.2012.00304
...
Horne and Ostberg (1976) is the canonical MEQ article and is commonly cited without a DOI. `10.1037/t02254-000` resolves, but it resolves to the APA PsycTESTS questionnaire record, not the original *International Journal of Chronobiology* article. I left the original article in the reference list without a DOI and noted the PsycTESTS DOI only in `references.bib`.

Byrne and Murray (2017), proposed in `docs/citation_candidates_expanded.md` as a reward-system/circadian-rhythms review, could not be matched to a clear article record. Use the verified Murray et al. (2009), McClung (2007), Hasler and Clark (2013), and Webb et al. (2009) references for this mapped mechanism unless co-authors provide the exact Byrne/Murray source.
